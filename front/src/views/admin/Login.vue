<template>
    <v-container class="home" style='' fluid fill-height>
        <v-card class='card_login' width='80%' style='#border:5px solid black !important'>
            <div class='cols_card'>
                <form action="" style='#border:5px solid red !important;padding:5rem;background-color:rgb(106, 143, 212,1) !important;' @submit.prevent="login(usuario)">
                    <div>
                        <h1>Sign in</h1>
                    ...
                    <div class='mt-5'>
                        <v-text-field label="Email" prepend-inner-icon="mdi-email" outlined dark v-model="usuario.user"></v-text-field>
                        <v-text-field label="Password" prepend-inner-icon="mdi-lock" outlined v-model="usuario.password" dark></v-text-field>
                        <br>
                        <p><strong>Forgot your password?</strong></p>
                        <v-btn class='mt-5' elevation="2" rounded x-large color="primary" type="submit">Sign In</v-btn>
                    </div>
                </form>
            </div>
            <div class='img_collage cols_card'>
                <div class='text_efect'>
                    <h1 class='text-center'>Our <strong>Gallery</strong></h1>
